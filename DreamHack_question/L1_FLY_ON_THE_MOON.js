...
function initTunnel() {
    ...
    $('img.left_wall')['each'](function(_0x8618x16) {R
        y = _0x8618x16 * 25;
        $(this)['css']('top', '' + y + 'px');
...
// 이 코드에서 점수에 해당하는 값을 찾아보자
// GETSCORE라는 함수나 눈에 보인다
// GETSCORE 은 _0x8618x7() 값을 반환한다
// _0x8618x7()은 _0x8618x6을 반환하는데 이 값이 점수인 것 같다
// VAR _0x8618x6 = 0 의 값을 50000정도로 바꾸고
// 콘솔창에 바꾼 소스코드를 넣고 실행하면
// FLAG를 얻을 수 있다.